...
print('---------------------------------------------------------------------------------')
print('Generating Descriptive Accuracy Graph')
print('---------------------------------------------------------------------------------')
print('')

x_axis_mems = [20, 15, 10, 5] 
# MEMS

#RF 
y_axis_RF = [0.71, 0.69, 0.62, 0.62] #changed
#DNN 
y_axis_DNN = [0.72, 0.68, 0.66, 0.45] #changed
# SGD
y_axis_SVM = [0.63, 0.66, 0.68, 0.56] # changed 
#DT
y_axis_DT = [0.72, 0.69, 0.65, 0.65] #changed
# MLP
y_axis_MLP = [0.71, 0.71, 0.69 ,0.46] # changed
...
# Show the plot
plt.show()
plt.savefig('GRAPH_DESC_ACC_SHAP_MEMS.png')
plt.clf()