...
#RF 
y_axis_RF = [0.72, 0.72, 0.72, 0.71] #changed
#DNN 
y_axis_DNN = [0.72, 0.72, 0.72, 0.68] #changed
#SGD
#y_axis_SVM = [0.55, 0.54, 0.50] 
#DT
y_axis_DT = [0.72, 0.72, 0.72, 0.72] #changed
# MLP
y_axis_MLP = [0.72, 0.66, 0.67, 0.67] #changed
...
# Show the plot
plt.show()
plt.savefig('GRAPH_DESC_ACC_LIME_MEMS.png')
plt.clf()