...
df = pd.read_csv('/N/u/agummadi/BigRed200/robustness_datasets/threshold_results_mems_shap.csv', index_col=0)
...
# print('type:', type(f1s), type(fsts), type(ax))

# sns.scatterplot(f1s, fsts, ax=ax)
sns.scatterplot(x=f1s, y=fsts, ax=ax)

plt.savefig("mems_ROBUSTNESS_shap_f1_first.png")
...
# Save the plot
plt.savefig("mems_ROBUSTNESS_SHAP_f1_first_with_binned_trend.png")
