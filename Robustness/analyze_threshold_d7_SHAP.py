...
df = pd.read_csv('/N/u/agummadi/BigRed200/robustness_datasets/threshold_results_d7_shap.csv', index_col=0)
...
plt.savefig("d7_ROBUSTNESS_shap_f1_first.png")
...
# Save the plot
plt.savefig("d7_ROBUSTNESS_SHAP_f1_first_with_binned_trend.png")
