...
params = Params("/N/u/agummadi/BigRed200/xai_metrics_sp24/Robustness/model_configurations/experiment_params.json")
np.random.seed(params.seed)
# X, y, cols = get_and_preprocess_compas_data(params)

X, y, cols = get_and_preprocess_mems(params)
...
def experiment_main(X, y):
	...
	if LIME:
		...
		limeorshap = 'shap'
	df.to_csv('robustness_datasets/threshold_results_mems_{}.csv'.format(limeorshap))
