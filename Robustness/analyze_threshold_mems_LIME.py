...
df = pd.read_csv('/N/u/agummadi/BigRed200/robustness_datasets/threshold_results_mems_lime.csv', index_col=0)
...
plt.savefig("mems_ROBUSTNESS_LIME_f1_first.png")
...
# Save the plot
plt.savefig("mems_ROBUSTNESS_LIME_f1_first_with_binned_trend.png")
